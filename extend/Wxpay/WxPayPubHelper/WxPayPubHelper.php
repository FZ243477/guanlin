...
{	
	...
	/**
	 * 获取prepay_id
	 * prepay_id就是指下单时生成的订单id，通过调用“统一下单”接口(https://api.mch.weixin.qq.com/pay/unifiedorder)来获取
	 */
...
//		dump($this->result);
		...
		/* $this->result=array(9) {
			  ...
			  ["appid"] => string(18) "wxae5d3a0258214651"
			  ["mch_id"] => string(10) "‪1393086602‬"
			  ["nonce_str"] => string(16) "TtReE414gJydaxoD"
			  ["sign"] => string(32) "187ED0359198E108B53F925B3D1162C0"
			  ["result_code"] => string(7) "SUCCESS"
			  ["prepay_id"] => string(36) "wx201702172216226b7d781fc50799988493"
